class Robot {
    ...
    charge(amount) {
        ...
        if (this.power === 100) console.log("I am at optimal operational capacity.");
    }

    move(distance) {
        if (this.power < distance) console.log(`I do not have enough power to move ${distance} units.`);
        else {
